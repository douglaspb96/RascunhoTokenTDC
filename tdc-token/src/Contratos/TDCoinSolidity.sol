...
contract TDCoin {
    ...
    constructor() public {
        ...
        name = "TDCoin";                                   // Set the name for display purposes
        symbol = "TDC";                               // Set the symbol for display purposes
        ownerTDCoin = msg.sender;
    }
    ...
    * Get tokens balance
    * 
    * @param _sender The address of the sender for get balance
    */
    ...
    */
    ...
    function buy(uint256 _value) public returns (bool success) {
        _transfer(ownerTDCoin, msg.sender, _value);
        return true;
    }
